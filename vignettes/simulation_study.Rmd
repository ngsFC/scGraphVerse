...
```{r communities-demo}
# Alternative: Simple community detection without external validation
comm_truth <- community_path(adj_truth, plot = FALSE, verbose = FALSE)
comm_cons <- community_path(consensus, plot = FALSE, verbose = FALSE)
