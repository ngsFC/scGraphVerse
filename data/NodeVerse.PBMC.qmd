...
png(paste(pdir, "genie3_late_pbmc1000_auc.png", sep = "/"), width = 2400, height = 1800, res = 300)
...
png(paste(pdir, "genie3_late_pbmc1000_scores.png", sep = "/"), width = 2400, height = 1800, res = 300)
scores.genie3.late.all <- pscores(adjm, sgenie3_late_adj)
dev.off()

png(paste(pdir, "genie3_late_pbmc1000_mplots.png", sep = "/"), width = 2400, height = 2400, res = 300)
...
png(paste(pdir, "genie3_late_pbmc1000_vote_score.png", sep = "/"), width = 2400, height = 2400, res = 300)
scores.genie3.late <- pscores(adjm, list(consesusm))
dev.off()
png(paste(pdir, "genie3_late_pbmc1000_union_score.png", sep = "/"), width = 2400, height = 2400, res = 300)
scoresu.genie3.late <- pscores(adjm, list(consesusu))
dev.off()
png(paste(pdir, "genie3_late_pbmc1000_inet_score.png", sep = "/"), width = 2400, height = 2400, res = 300)
...
```{r}
png(paste(pdir, "genie3_late_pbmc1000_vote_plot.png", sep = "/"), width = 4000, height = 2400, res = 300)
ajm_compared <- compare_consensus(consesusm, adjm)
dev.off()
png(paste(pdir, "genie3_late_pbmc1000_union_plot.png", sep = "/"), width = 4000, height = 2400, res = 300)
ajm_compared <- compare_consensus(consesusu, adjm)
dev.off()
png(paste(pdir, "genie3_late_pbmc1000_inet_plot.png", sep = "/"), width = 4000, height = 2400, res = 300)
...
png(paste(pdir, "genie3_early_pbmc1000_auc.png", sep = "/"), width = 2400, height = 1800, res = 300)
...
png(paste(pdir, "genie3_early_pbmc1000_scores.png", sep = "/"), width = 2400, height = 1800, res = 300)
scores.genie3.early <- pscores(adjm, sgenie3_early_adj)
dev.off()

png(paste(pdir, "genie3_early_pbmc1000_mplots.png", sep = "/"), width = 2400, height = 2400, res = 300)
...
```{r}
png(paste(pdir, "genie3_early_pbmc1000_plot.png", sep = "/"), width = 4000, height = 2400, res = 300)
...
png(paste(pdir, "grnboost_late_pbmc1000_auc.png", sep = "/"), width = 2400, height = 1800, res = 300)
...
png(paste(pdir, "grnboost_late_pbmc1000_scores.png", sep = "/"), width = 2400, height = 1800, res = 300)
scores.grnboost.late.all <- pscores(adjm, sgrnboost_late_adj)
dev.off()

png(paste(pdir, "grnboost_late_pbmc1000_mplots.png", sep = "/"), width = 2400, height = 2400, res = 300)
...
png(paste(pdir, "grnboost_late_pbmc1000_vote_score.png", sep = "/"), width = 2400, height = 2400, res = 300)
scores.grnboost.late <- pscores(adjm, list(consesusm))
dev.off()
png(paste(pdir, "grnboost_late_pbmc1000_union_score.png", sep = "/"), width = 2400, height = 2400, res = 300)
scoresu.grnboost.late <- pscores(adjm, list(consesusu))
dev.off()
png(paste(pdir, "grnboost_late_pbmc1000_inet_score.png", sep = "/"), width = 2400, height = 2400, res = 300)
...
```{r}
png(paste(pdir, "grnboost_late_pbmc1000_vote_plot.png", sep = "/"), width = 4000, height = 2400, res = 300)
ajm_compared <- compare_consensus(consesusm, adjm)
dev.off()
png(paste(pdir, "grnboost_late_pbmc1000_union_plot.png", sep = "/"), width = 4000, height = 2400, res = 300)
ajm_compared <- compare_consensus(consesusu, adjm)
dev.off()
png(paste(pdir, "grnboost_late_pbmc1000_inet_plot.png", sep = "/"), width = 4000, height = 2400, res = 300)
ajm_compared <- compare_consensus(consesunet, adjm)
dev.off()
...
png(paste(pdir, "grnboost_early_pbmc1000_auc.png", sep = "/"), width = 2400, height = 1800, res = 300)
...
png(paste(pdir, "grnboost_early_pbmc1000_scores.png", sep = "/"), width = 2400, height = 1800, res = 300)
scores.grnboost.early <- pscores(adjm, sgrnboost_early_adj)
dev.off()

png(paste(pdir, "grnboost_early_pbmc1000_mplots.png", sep = "/"), width = 2400, height = 2400, res = 300)
...
```{r}
png(paste(pdir, "grnboost_early_pbmc1000_plot.png", sep = "/"), width = 4000, height = 2400, res = 300)
