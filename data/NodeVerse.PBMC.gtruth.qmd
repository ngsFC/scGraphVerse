...
expression_matrices[[1]] <- as.matrix(expression_matrices[[1]])
expression_matrices[[2]] <- as.matrix(expression_matrices[[2]])
expression_matrices[[3]] <- as.matrix(expression_matrices[[3]])

expression_matrices[[1]] <- expression_matrices[[1]][rownames(expression_matrices[[1]]) %in% pathgenes, ]
expression_matrices[[2]] <- expression_matrices[[2]][rownames(expression_matrices[[2]]) %in% pathgenes, ]
expression_matrices[[3]] <- expression_matrices[[3]][rownames(expression_matrices[[3]]) %in% pathgenes, ]

expression_matrices[[1]] <- t(expression_matrices[[1]])
expression_matrices[[2]] <- t(expression_matrices[[2]])
expression_matrices[[3]] <- t(expression_matrices[[3]])
