...
```{r}
write.table(keepscores, paste(ddir, "met1.txt", sep = ""), quote = F, col.names = T, row.names = F, sep = "\t")
...
write.table(time_data, paste(ddir, "time1.txt", sep = ""), quote = F, col.names = T, row.names = T)
