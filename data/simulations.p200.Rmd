...
```{r}
write.table(keepscores, paste(ddir, "met2.txt", sep = ""), quote = F, col.names = T, row.names = F, sep = "\t")
...
write.table(time_data, paste(ddir, "time2.txt", sep = ""), quote = F, col.names = T, row.names = T)
