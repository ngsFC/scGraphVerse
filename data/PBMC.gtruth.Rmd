...
pathgenes <- selgenes(seurat_object = seurat_subset_filt, cell_type = "CD4-positive helper T cell", top_n = 1200)
...
pathgenes <- selgenes(seurat_object = seurat_subset_filt, cell_type = "CD4-positive helper T cell", top_n = 500)
...
simat <- zinb_simdata(
  ...
  pi = c(0.2, 0.2, 0.2),  
  kmat = 3,
  depth_range = c((3*nodes)-200, (3*nodes)+200)
)
...
simat <- zinb_simdata(
  ...
  pi = c(0.2, 0.2, 0.2),  
  kmat = 3,
  depth_range = c((3*nodes)-300, (3*nodes)+300)
)
...
pathgenes <- selgenes(seurat_object = seurat_subset_filt, cell_type = "CD4-positive helper T cell", top_n = 200)
...
simat <- zinb_simdata(
  ...
  pi = c(0.2, 0.2, 0.2),  
  kmat = 3,
  depth_range = c((3*nodes)-100, (3*nodes)+100)
)
...
pathgenes <- selgenes(seurat_object = seurat_subset_filt, cell_type = "CD4-positive helper T cell", top_n = 1600)
...
simat <- zinb_simdata(
  ...
  pi = c(0.2, 0.2, 0.2),  
  kmat = 3,
  depth_range = c((3*nodes)-700, (3*nodes)+700)
)
