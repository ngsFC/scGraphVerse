...
sgrnb_late <- symmetrize(grnb_late, weight_function = "mean")
...
sgenie3_early <- symmetrize(list(genie3_early[[1]]), weight_function = "mean")
...
sgrnb_early <- symmetrize(list(grnb_early[[1]]), weight_function = "mean")
...
sjrf_mat <- symmetrize(jrf_mat, weight_function = "mean")
