...
genes <- rownames(count_matrices[[1]])
out.perm <- Run_permutation(lapply(count_matrices, t),mtry=round(sqrt(length(genes)-1)),ntree=500, genes,5)
final.net <- JRF_network(jrf_mat,out.perm,0.001)
```
