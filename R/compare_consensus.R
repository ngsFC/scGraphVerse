...
#' @param reference_matrix Optional. A binary square adjacency matrix representing the reference
#'   (ground truth) network. If \code{NULL}, a STRINGdb high-confidence physical interaction
#'   network (human, score > 900) is used.
#' @param false_plot Logical. If \code{TRUE}, an additional plot of False Positives (FP) is generated.
